            ...
            <ul class="mui-table-view">
                <div class="mui-input-row">
                    ...
                    <li class="mui-table-view-cell">
                        <a class="mui-navigate-right" id="sex">请选择性别</a>
                    </li>
                </div>
            </ul>
            <ul class="mui-table-view">
...
<script src="${pageContext.request.contextPath}/js/mui.picker.min.js"></script>
<script src="${pageContext.request.contextPath}/js/city.data-3.js"></script>
...
<script>
    ...
    next.addEventListener('tap',function(){
        ...
        mui.ajax({
            url:'/wxsubscribe/viphyOpenCard?wxopenid='+ localStorage.wxopenid,
    ...
    window.onload=function(){
        xm.value= localStorage.nickname;
        sex.innerHTML= localStorage.sex;
        region.innerHTML=localStorage.area;
    }
</script>
</html>
