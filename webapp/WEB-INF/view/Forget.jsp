...
<div>
    <header class="mui-bar mui-bar-nav">
        <a class=" mui-icon mui-icon-left-nav mui-pull-left"  href="#" id="UpdatePwd"></a>
            ...
            <li class="mui-table-view-cell mui-media">
                <form class="mui-input-group" id="app">
                    <div class="mui-input-row">
                        <label>卡号</label>
                        <input type="text" class="mui-input-clear" placeholder="填写卡号" id="vipcard"  style="border-bottom: 1px solid #ccc;color: #a8a8a8" disabled>
                    </div>
                    <div class="mui-input-row" >
                        <label>验证码</label>
...
<script type="text/javascript">
    ...
    document.getElementById("getTelCode").addEventListener('tap',function () {
        ...
        mui.ajax({
            url: '/wxsubscribe/updateVipPassSendEmail/' + localStorage.vipcard,
    ...
    updateVipPassByEmailCode.addEventListener('tap', function () {
        ...
        mui.ajax({
            url: '/wxsubscribe/updateVipPassByEmailCode/' + localStorage.vipcard,
